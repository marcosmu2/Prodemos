        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedBy = table.Column<string>(type: "NVARCHAR(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagUrl = table.Column<string>(type: "NVARCHAR(400)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR(36)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "NVARCHAR(36)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPlays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPlays_Championships_ChampionshipId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserPlayId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MatchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScoreTeamAGuessed = table.Column<int>(type: "int", nullable: false),
                    ScoreTeamBGuessed = table.Column<int>(type: "int", nullable: false),
                    GuessStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR(36)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "NVARCHAR(36)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGuests_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGuests_UserPlays_UserPlayId",
                        column: x => x.UserPlayId,
                        principalTable: "UserPlays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGuests_MatchId",
                table: "UserGuests",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGuests_UserPlayId",
                table: "UserGuests",
                column: "UserPlayId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPlays_ChampionshipId",
                table: "UserPlays",
                column: "ChampionshipId");
        }
